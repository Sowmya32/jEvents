class ApplicationController < ActionController::Base
	...
	def store_location
	  ...
	  session[:previous_url] = request.fullpath unless (request.fullpath =~ /\/users/ || request.fullpath =~ /\/venues\/show_image/ || request.fullpath =~ /\/ratings\/rate/ || request.fullpath =~ /\/feedbacks\/new/)
	end
